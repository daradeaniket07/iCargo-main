...
// export default function FwbPageInner() {
      ...
      <div className="w-full max-w-[980px] mx-auto">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-t px-3 sm:px-4 py-3 
          ...
          <div className="flex flex-wrap gap-2">
            <button
              onClick={handlePrint}
              className="px-3 py-1 bg-white border rounded text-xs sm:text-sm"
            >
              Print
            </button>
        ...
        {/* ---------- CONTENT BOX ---------- */}
        <div className="bg-white border rounded-b p-3 sm:p-4 shadow-sm">

          <pre
            className="whitespace-pre-wrap overflow-auto text-[10px] sm:text-xs leading-5 font-mono"
